...
`)},Lp=r=>se({axis:r.attributes.getInt("axis")}),aI=r=>{if(!r||r.length<1)throw new Error("too few inputs");let e=r[0].type,n=r[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of r){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==n)throw new Error("input tensors should have the same shape")}}});function sI(){return yt("abs")}function uI(){return yt("acos")}function lI(){return yt("asin")}function cI(){return yt("atan")}function dI(){return yt("ceil")}function pI(){return yt("cos")}function fI(r){let e="elu";return{body:`
  ...
  `,name:r,type:0}}var SI,ze,Rp,zp,Bp,Mp,uu,Fp,Vp,$I,Gp,Up,Wp,Hp,qp,jp,lu,Kp,Xp,Zp,Jp,Qp,Yp,ef,tf,nf,rf,of,cu=$(()=>{"use strict";We();xe();An();De();pe();SI=(r,e,n,t)=>{let o=r.session.pack?2:0,i=q(r.session.backend.glContext.version);return{...e,output:{dims:n.dims,type:n.type,textureType:o},shaderSource:`
     ${t.body}
     void main() {
...
`)},T2=r=>{if(!r||r.length!==1)throw new Error("ImageScaler requires 1 input.");if(r[0].dims.length!==4)throw new Error("Invalid input shape.");if(r[0].type!=="float32"&&r[0].type!=="float64")throw new Error("Invalid input type.")}});var Ff,Vf,Mf,v2,I2,S2,$2,A2,P2,Gf=$(()=>{"use strict";De();pe();Ff=(r,e,n)=>{P2(e);let t=r.run(I2(e[0]),e);return[r.run(A2(r,e[0],n,t.dims),[e[0],t,e[1],e[2]])]},Vf=r=>r.attributes.getFloat("epsilon",1e-5),Mf={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},v2=(r,e)=>{let n=e.dims.slice(),t=n[1],o=n[2]*n[3],i=[n[0],t],a=`
      vec4 process(int[2] indices) {
        ...
        return v;
      }`;return{...r,output:{dims:i,type:e.type,textureType:4},shaderSource:a}},I2=r=>({...Mf,get:()=>v2(Mf,r)}),S2={name:"InstanceNormalization_ComputeOutput",inputNames:["X","MeanAndVariance","Scale","B"],inputTypes:[0,4,0,0]},$2=(r,e,n,t,o)=>{let i=q(r.session.backend.glContext.version),[a,s]=r.calculateTextureWidthAndHeight(o,4),[u,l]=[a/4,s],c=`
...
`);let y="";c<2&&l>0?y="coords":y=i.map((O,E)=>`coords.${m[E+f]}`).join(", ");let g="return outputValue;",x=G.size(i)===1,v=G.size(a)===1;if(l===1&&!x&&!v)g=`
    ...
    `;return new B(P,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(e,n,t,o){let i=[t.width,t.height],a=[n.width,n.height],s=n.unpackedShape.length,u=t.unpackedShape.length,l=n.unpackedShape,c=t.unpackedShape,d=Mo(o);if(s===u&&Jn.arraysEqual(a,i)){let x=`
          float ${e}() {
...
`);let g="";u<2&&s>0?g="coords":g=n.unpackedShape.map((x,w)=>`coords.${y[w+h]}`).join(", ");let b=`
    ...
    }`;return new B(u,["coordinates.packedUVfrom1D"])}getPackedSampler2D(e,n,t){let o=t.unpackedShape,i=[t.width,t.height],a=q(this.context.glContext.version),s=i[0],u=i[1];if(i!=null&&Jn.arraysEqual(o,i)){let f=`vec4 ${e}(int row, int col) {
    ...
    `;return{toVec:new B(s,["coordinates.coordsToOffset"])}}valueFrom(){let e={};return this.context.programInfo.inputNames.forEach((n,t)=>{let o=this.context.inputTextureLayouts[t],a=(o.unpackedShape.length>0?o.unpackedShape:o.shape).length,s=`_${n}`;e[s]=new B(this.getValueFromSingle(n,a,o.width,o.height,!1),[`shapeUtils.indicesToOffset${s}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"]),s=s+"_T",e[s]=new B(this.getValueFromSingle(n,a,o.width,o.height,!0),[`shapeUtils.indicesToOffset${s}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"])}),e}getValueFromSingle(e,n,t,o,i){let a=`_${e}`;i&&(a=a+"_T");let s=q(this.context.glContext.version);return`
        ...
        `}}});var ti,cm=$(()=>{"use strict";An();ti=class r extends gt{constructor(e){super(e)}getFunctions(){return{...this.encodeFloat32(),...this.decodeFloat32()}}getCustomTypes(){return{}}encodeFloat32(){return{encode:new B(`highp vec4 encode(highp float f) {
      ...
      `}incrementIndices(){let e={};return this.context.programInfo.inputNames.forEach((n,t)=>{let o=this.context.inputTextureLayouts[t].shape,i=o.length,a=`incrementIndices_${n}`,s="";for(let l=0;l<i;++l)s+=`
        ...
        `;e[a]=new B(u)}),e}}});var oi,fm=$(()=>{"use strict";An();oi=class extends gt{constructor(e){super(e)}getCustomTypes(){return{}}getFunctions(){return{...this.binaryVecFunctions(),...this.copyVec(),...this.setVecItem(),...this.getVecItem()}}binaryVecFunctions(){let n=this.context.outputTextureLayout.shape.length,t={add:"+=",sub:"-=",mul:"*=",div:"/="},o={};for(let i in t){let a=`${i}Vec`,s="";for(let l=0;l<n;++l)s+=`
          dest[${l}] ${t[i]} src[${l}];
          `;let u=`
...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=n=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(n)];return this.uniforms.map(n=>[e(n.type),n.length??1])}},pg=(r,e)=>new Qu(r,e)});var KS,fg,XS,ZS,JS,QS,Ge,hg,mg,Pn=$(()=>{"use strict";X();ee();ke();ne();KS=(r,e)=>{if(!r||r.length!==1)throw new Error("Transpose requires 1 input.");if(e.length!==0&&e.length!==r[0].dims.length)throw new Error(`perm size ${e.length} does not match input rank ${r[0].dims.length}`)},fg=(r,e)=>e.length!==0?e:[...new Array(r).keys()].reverse(),XS=(r,e)=>S.sortBasedOnPerm(r,fg(r.length,e)),ZS=(r,e,n,t)=>{let o=`fn perm(i: ${t.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let i=0;i<e;++i)o+=`a[${r[i]}]=i[${i}];`;return o+="return a;}"},JS=(r,e)=>{let n=[],t=[];for(let o=0;o<r.length;++o)r[o]!==1&&n.push(r[o]),r[e[o]]!==1&&t.push(e[o]);return{newShape:n,newPerm:t}},QS=(r,e)=>{let n=0;for(let t=0;t<r.length;++t)if(e[r[t]]!==1){if(r[t]<n)return!1;n=r[t]}return!0},Ge=(r,e)=>{let n=r.dataType,t=r.dims.length,o=fg(t,e),i=XS(r.dims,o),a=r.dims,s=i,u=t<2||QS(o,r.dims),l;if(u)return l=m=>{let y=A("input",n,a,4),g=C("output",n,s,4);return`
...
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = min(value, ${t.getByIndices("input_indices")});`,""]})},b1=(r,e)=>{_n(r.inputs),xn(r,"ReduceProd",e,(t,o)=>[`var value = ${o.type.storage}(1);`,"",`value *= ${t.getByIndices("input_indices")};`,""])},y1=(r,e)=>{_n(r.inputs),xn(r,"ReduceSum",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,""])},_1=(r,e)=>{_n(r.inputs),xn(r,"ReduceSumSquare",e,(t,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += t * t;`,""])},wn=(r,e,n)=>{if(e.length===0)return n;let t=1,o=1;for(let i=0;i<e.length;i++)e.indexOf(i)===-1?t*=r[i]:o*=r[i];return o<32&&t>1024},Ag=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?m1(r,e):gg(r,e)},Pg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?d1(r,e):bg(r,e)},Og=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?p1(r,e):yg(r,e)},Eg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?f1(r,e):_g(r,e)},Cg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?h1(r,e):xg(r,e)},Dg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?g1(r,e):wg(r,e)},kg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?b1(r,e):Tg(r,e)},Lg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?y1(r,e):vg(r,e)},Ng=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?_1(r,e):Ig(r,e)},Rg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?c1(r,e):Sg(r,e)}});var zg,Bg,Mg,nl,Fg=$(()=>{"use strict";X();ke();Vi();zg=r=>{if(!r||r.length===0||r.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(r[0].dataType!==1)throw new Error("Invalid input type.")},Bg=(r,e)=>{zg(r.inputs);let n=(t,o,i)=>{let a=[];for(let s=0;s<t.rank;s++)(i.indexOf(s)>=0||i.length===0)&&a.push(`input_indices[${s}] = 0;`);return[`${a.join(`
...
var best_index : i32 = 0;`,`if (${t.getByIndices("input_indices")} ${e.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${e.epsilon}_${e.format}_${t}_${a}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:b,getRunData:()=>({outputs:[{dims:r[0].dims,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...k(i)]:[{type:12,data:u}]})}},A1=r=>Z(r),Gg=(r,e)=>{let{inputs:n,outputCount:t}=r,o=A1({...e,outputCount:t});if(Y.webgpu.validateInputContent&&S1(n,o),e.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");r.compute($1(n,o))}});var P1,O1,Wg,Hg=$(()=>{"use strict";ee();ne();P1=r=>{if(r[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(r[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(r[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(r[0].dims[2]!==r[1].dims[0])throw new Error("last dimension of input and bias are not the same")},O1=r=>{let e=r[0].dims,n=r[0].dims[2],t=S.size(e)/4,o=r[0].dataType,i=A("input",o,e,4),a=A("bias",o,[n],4),s=A("residual",o,e,4),u=C("output",o,e,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:e,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(t/64)}}),getShaderSource:c=>`
  ...
  }`}},Wg=r=>{P1(r.inputs),r.compute(O1(r.inputs))}});var E1,be,qg,jg,Kg,Xg,Zg,Jg,Qg,Yg,eb,C1,tb,nb,rb,ob,no,ib,Wi,ab,sb,ub,lb,cb,db,pb,fb,hb,mb,gb,bb,yb,_b,xb,wb,Tb,vb,ol,il,Ib,Sb,$b,D1,k1,Ab,Hi=$(()=>{"use strict";X();ee();ke();ne();E1=(r,e,n,t,o,i,a)=>{let s=Math.ceil(e/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let l=A("inputData",n,[s],4),c=C("outputData",t,[s],4),d=[{name:"vec_size",type:"u32"}];return a&&d.push(...a),`
...
`,il=r=>`(fast_gelu_a + fast_gelu_a * tanh_v(${r} * (fast_gelu_c * ${r} * ${r} + fast_gelu_b))) * ${r}`,Ib=r=>{let e=Ve(r.inputs[0].dataType);r.compute(be(r.inputs[0],"FastGelu",il,ol(e),void 0,r.inputs[0].dataType))},Sb=(r,e)=>{let n=Ve(r.inputs[0].dataType);return r.compute(be(r.inputs[0],"ThresholdedRelu",t=>`select(vec4<${n}>(0.0), ${t}, ${t} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${e.alpha});`,e.cacheKey)),0},$b=r=>{r.compute(be(r.inputs[0],"Log","log"))},D1=(r,e)=>`
...
`,k1=r=>`quick_gelu_impl(${r})`,Ab=(r,e)=>{let n=Ve(r.inputs[0].dataType);r.compute(be(r.inputs[0],"QuickGelu",k1,D1(n,e.alpha),e.cacheKey,r.inputs[0].dataType))}});var L1,N1,Ob,Eb=$(()=>{"use strict";ee();ne();Hi();L1=r=>{if(r[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(r[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(r[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(r[0].dims[2]!==r[1].dims[0])throw new Error("last dimension of input and bias are not the same")},N1=r=>{let e=r[0].dims.slice();e[2]=e[2]/2;let n=A("input",r[0].dataType,r[0].dims,4),t=A("bias",r[0].dataType,[r[0].dims[2]],4),o=C("output",r[0].dataType,e,4),i=S.size(e)/4,a=ve(r[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:e,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
...
`}return W};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${e.activation};${d};${p};${f};${o}`,inputDependencies:m?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:x}),getShaderSource:w}}});var U1,W1,al,Kb,H1,sl,q1,oo,Zi=$(()=>{"use strict";X();ee();ne();Gn();Xi();ji();U1=(r,e)=>r?`
...
`},q1=(r,e,n,t,o=!1)=>{let[i,a,s,u]=t,l=ve(t[0].type.tensor);return`
  ...
  ${h.mainStart()}
    ...
    ${xt}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${e.cacheKey};${c}${m}${h}${d}${f}`,inputDependencies:b},getRunData:()=>({dispatchGroup:{x:g[0],y:g[1],z:g[2]},outputs:[{dims:n?n(o):o,dataType:r[0].dataType}],programUniforms:O}),getShaderSource:E}}});var t$,n$,r$,ly,cy,o$,dy,i$,py,fy=$(()=>{"use strict";uy();Gn();Pn();t$=(r,e,n,t,o,i)=>(r-1)*e+n+(t-1)*o+1-i,n$=(r,e,n,t,o)=>{let i=Math.floor(r/2);e==="SAME_UPPER"?(n[t]=i,n[o]=r-i):e==="SAME_LOWER"&&(n[t]=r-i,n[o]=i)},r$=(r,e,n,t,o,i,a,s,u,l)=>{let c=r.length-2,d=l.length===0;u.length<c&&u.push(...Array(c-u.length).fill(0));let p=r[0],f=e[s?3:1]*o;for(let h=0,m=r.length-c-(s?1:0);h<c;++h,++m){let y=r[m],g=d?y*a[h]:l[h],b=t$(y,a[h],i[h],e[m],n[h],g);n$(b,t,i,h,h+c),d&&l.push(a[h]*(y-1)+u[h]+(e[m]-1)*n[h]+1-i[h]-i[h+c])}l.splice(0,0,p),l.splice(s?3:1,0,f)},ly=(r,e)=>{let n=r.kernelShape.slice();if(r.kernelShape.length===0||r.kernelShape.reduce((d,p)=>d*p,1)===0){n.length=0;for(let d=2;d<e[1].dims.length;++d)n.push(e[1].dims[d])}let t=r.format==="NHWC";n.splice(0,0,e[1].dims[0]),n.splice(t?3:1,0,e[1].dims[1]);let o=r.pads.slice(),i=r.outputShape.slice(),a=r.outputPadding.slice(),s=e[0].dims,u=r.dilations.slice();if(u.reduce((d,p)=>d+p,0)===0){let d=e[0].dims.length-2;u=new Array(d).fill(1)}let l=r.strides.slice();if(l.reduce((d,p)=>d+p,0)===0){let d=e[0].dims.length-2;l=new Array(d).fill(1)}r$(s,n,u,r.autoPad,r.group,o,l,t,a,i);let c=Object.assign({},r);return Object.assign(c,{kernelShape:n,pads:o,outputPadding:a,outputShape:i,dilations:u,strides:l}),c},cy=r=>{let e=qi(r),n=r.format,t=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof r.autoPad>"u"?0:r.autoPad],o=r.dilations,i=r.group??1,a=r.kernelShape,s=r.pads,u=r.strides,l=r.wIsConst(),c=r.outputPadding,d=r.outputShape;return{autoPad:t,format:n,dilations:o,group:i,kernelShape:a,outputPadding:c,outputShape:d,pads:s,strides:u,wIsConst:l,...e,cacheKey:`${r.format};${e.activation};`}},o$=(r,e)=>{if(!r||r.length!==2&&r.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(r[0].dims.length!==4&&r[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(r[0].dims.length!==r[1].dims.length)throw new Error("filter does not have same dimension as input");let n=r[0].dims[e.format==="NHWC"?r[0].dims.length-1:1],t=r[1].dims[0];if(n!==t)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=r[1].dims[1]*e.group;if(r.length===3&&(r[2].dims.length!==1||r[2].dims[0]!==o))throw new Error("invalid bias");let i=r[0].dims.length-2;if(e.dilations.reduce((c,d)=>c+d,0)>0&&e.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(e.strides.reduce((c,d)=>c+d,0)>0&&e.strides.length!==i)throw new Error(`strides should be ${i}D`);if(e.pads.reduce((c,d)=>c+d,0)>0&&e.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(e.outputPadding.length!==i&&e.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(e.kernelShape.reduce((c,d)=>c+d,0)>0&&e.kernelShape.length!==0&&e.kernelShape.length!==r[1].dims.length-2)throw new Error("invalid kernel shape");if(e.outputShape.length!==0&&e.outputShape.length!==r[0].dims.length-2)throw new Error("invalid output shape")},dy=(r,e,n,t)=>{let o=r.kernelCustomData.wT??r.compute(Ge(e[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!r.kernelCustomData.wT&&(r.kernelCustomData.wT=o);let i=[e[0],o];e.length===3&&i.push(e[2]),r.compute(sy(i,n,t),{inputs:i})},i$=(r,e)=>{let n=e.format==="NHWC",t=[r.inputs[0].reshape(n?[r.inputs[0].dims[0],1,r.inputs[0].dims[1],r.inputs[0].dims[2]]:[r.inputs[0].dims[0],r.inputs[0].dims[1],1,r.inputs[0].dims[2]]),r.inputs[1].reshape([r.inputs[1].dims[0],r.inputs[1].dims[1],1,r.inputs[1].dims[2]])];r.inputs.length===3&&t.push(r.inputs[2]);let o=e.kernelShape;(o.length===0||o[0]===0)&&(o=[r.inputs[1].dims[2]]);let i=e.dilations;(i.length===0||i[0]===0)&&(i=[1]);let a=e.strides;(a.length===0||a[0]===0)&&(a=[1]);let s=e.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],a=[1].concat(a),i=[1].concat(i),o=[1].concat(o);let u=e.outputPadding;u=[0].concat(u);let l=ly({...e,pads:s,strides:a,dilations:i,kernelShape:o,outputPadding:u},t);dy(r,t,l,c=>n?[c[0],c[2],c[3]]:[c[0],c[1],c[3]])},py=(r,e)=>{if(o$(r.inputs,e),r.inputs[0].dims.length===3)i$(r,e);else{let n=ly(e,r.inputs);dy(r,r.inputs,n)}}});var a$,hy,my,gy=$(()=>{"use strict";X();ee();ke();ne();a$=(r,e,n,t)=>{let o=S.size(e),i=e.length,a=A("input",r,i),s=C("output",r,i),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=S.normalizeAxis(u,i),c=d=>{let p=` i32(${a.indicesGet("inputIndices","uniforms.axis")}) `,f=M("uniforms.input_shape","uniforms.axis",i),h=t.reverse?p+(t.exclusive?" + 1":""):"0",m=t.reverse?f:p+(t.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:e,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:l},...k(e,e)]}),getShaderSource:c}},hy=(r,e)=>{let n=r.inputs[0].dims,t=r.inputs[0].dataType,o=r.inputs[1];r.compute(a$(t,n,o,e),{inputs:[0]})},my=r=>{let e=r.exclusive===1,n=r.reverse===1;return Z({exclusive:e,reverse:n})}});var s$,u$,l$,by,yy,_y=$(()=>{"use strict";X();ee();ke();ne();s$=r=>{if(!r||r.length!==1)throw new Error("DepthToSpace requires 1 input.");if(r[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},u$=(r,e,n,t)=>{let o=[];o.push(`fn perm(i: ${t.type.indices}) -> ${n.type.indices} {
...
`)};
    ...
    ${h}`},c=[{type:12,data:u},...k(e,t)];return{name:"Expand",shaderCache:{hint:`${t.length};${a}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:t,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},$y=r=>{f$(r.inputs),r.compute(m$(r.inputs),{inputs:[0]})}});var g$,Py,Oy=$(()=>{"use strict";X();ee();ne();Hi();g$=r=>{let e=r[0].dataType,n=S.size(r[0].dims),t=S.size(r[1].dims),o=t%4===0,i=a=>{let s=A("x",e,[1],4),u=A("bias",e,[1],4),l=C("y",e,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],d=f=>`
  ...
  }`};return r.compute({name:"computeSliceOffsets",shaderCache:{hint:`${o.length}_${n.length}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:c,dataType:r.inputs[1].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:l}),getShaderSource:d},{inputs:[e],outputs:[-1]})[0]},ky=(r,e)=>{let n=r.inputs,t=n[0].dims,o=n[0].dataType,i=n[1].dims,a=i[i.length-1],s=S.sizeToDimension(i,i.length-1),u=S.sizeFromDimension(t,e.batchDims+a),l=S.sizeToDimension(t,e.batchDims),c=S.sizeFromDimension(t,e.batchDims),d=s/l,p=new Array(a),f=u;for(let w=0;w<a;++w)p[a-1-w]=f,f*=t[e.batchDims+a-1-w];let h=_$(r,n[1],p,e.batchDims,t,s,d,c,a),m=e.batchDims+a;if(m>t.length)throw new Error("last dimension of indices must not be larger than rank of input tensor");let y=i.slice(0,-1).concat(t.slice(m)),g=S.size(y),b=[{type:12,data:g},{type:12,data:u},...k(n[0].dims,h.dims,y)],x=w=>{let v=A("data",n[0].dataType,n[0].dims.length),I=A("slice_offsets",12,h.dims.length),P=C("output",n[0].dataType,y.length);return`
  ...
  }`};return d?{name:"GemmShared",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:l*c},programUniforms:f}),getShaderSource:y}:{name:"Gemm",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:f}),getShaderSource:m}},Gy=r=>{let e=r.transA,n=r.transB,t=r.alpha,o=r.beta;return{transA:e,transB:n,alpha:t,beta:o,cacheKey:`${r.transA};${r.transB};${r.alpha===1}`}},Uy=(r,e)=>{I$(r.inputs),r.compute(S$(r.inputs,e))}});var On,Un,Ar,Pr,$$,A$,P$,O$,E$,C$,D$,k$,Hy,qy,jy=$(()=>{"use strict";X();ee();ke();ne();[On,Un,Ar,Pr]=[0,1,2,3],$$=r=>{if(r[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(r[0].dims.length!==r[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(r[0].dims.length-2!==r[1].dims[r[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${r[0].dims.length-2}`);if(r[0].dims[0]!==r[1].dims[0])throw new Error("grid batch size must match input batch size")},A$=`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${r};${e}`,inputDependencies:i},getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u}),getShaderSource:l}},t_=(r,e)=>{let n=U$(r.inputs,e);if(r.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(r.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let t=r.inputs[0],o=r.inputs[1]&&r.inputs[1].dims.length>0?r.inputs[1]:void 0,i=r.inputs[2]&&r.inputs[2].dims.length>0?r.inputs[2]:void 0,a=r.inputs[3]&&r.inputs[3].dims.length!==0?r.inputs[3]:void 0,s=r.inputs[4]&&r.inputs[4].dims.length!==0?r.inputs[4]:void 0,u=r.inputs.length>4?r.inputs[5]:void 0,l=r.inputs.length>5?r.inputs[6]:void 0,c=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=Z({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,c*n.headSize,c*n.headSize]}),[p,f,h]=!o&&!i?r.compute(gl([t],d),{inputs:[t],outputs:[-1,-1,-1]}):[t,o,i],m,y;if(e.doRotary){let w=r.compute(H$(n.batchSize,n.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],v=r.inputs[7],I=r.inputs[8],P=Z({interleaved:e.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:e.scale}),O=[p,w,v,I],E=[-1];m=r.compute(Yi(O,P),{inputs:O,outputs:E})[0],O.splice(0,1,f);let R=Z({interleaved:e.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:e.scale});y=r.compute(Yi(O,R),{inputs:O,outputs:E})[0]}let g=io(r,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,e.doRotary?m:p,void 0,0),b=e_(r,e.doRotary?y:f,n),x=e_(r,h,n);$r(r,g,b,x,void 0,void 0,a,s,void 0,n,u,l)}});var r_,q$,j$,o_,i_=$(()=>{"use strict";X();ee();Pn();ne();r_=(r,e,n,t,o,i,a,s)=>{let u=he(i),l=u===1?"f32":`vec${u}f`,c=u===1?"vec2f":`mat2x${u}f`,d=o*a,p=64;d===1&&(p=256);let f=[o,a,i/u],h=[o,a,2],m=["rank","type","type"],y=[];y.push(...k(f,h));let g=b=>{let x=A("x",e.dataType,3,u),w=A("scale",n.dataType,n.dims),v=A("bias",t.dataType,t.dims),I=C("output",1,3,2),P=[x,w,v,I];return`
  ...
  }`};return r.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${s};${p}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:h,dataType:1}],dispatchGroup:{x:d},programUniforms:y}),getShaderSource:g},{inputs:[e,n,t],outputs:[-1]})[0]},q$=(r,e,n)=>{let t=e[0].dims,o=t,i=2,a=t[0],s=t[1],u=S.sizeFromDimension(t,i),l=he(u),c=S.size(o)/l,d=r_(r,e[0],e[1],e[2],a,u,s,n.epsilon),p=[a,s,u/l],f=[a,s],h=["type","none"],m=y=>{let g=A("x",e[0].dataType,p.length,l),b=A("scale_shift",1,f.length,2),x=C("output",e[0].dataType,p.length,l),w=[g,b,x];return`
  ...
  }`};r.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...k(p,f,p)]}),getShaderSource:m},{inputs:[e[0],d]})},j$=(r,e,n)=>{let t=e[0].dims,o=t,i=t[0],a=t[t.length-1],s=S.sizeFromDimension(t,1)/a,u=he(a),l=S.size(o)/u,c=[{type:12,data:s},{type:12,data:Math.floor(a/u)}],d=["type","type"],p=!1,f=[0,t.length-1];for(let g=0;g<t.length-2;g++)p=p||t[g+1]!==1,f.push(g+1);p=p&&t[t.length-1]!==1;let h=p?r.compute(Ge(r.inputs[0],f),{inputs:[r.inputs[0]],outputs:[-1]})[0]:r.inputs[0].reshape(Array.from({length:t.length},(g,b)=>t[f[b]])),m=r_(r,h,e[1],e[2],i,s,a,n.epsilon),y=g=>{let b=ve(e[0].dataType),x=u===1?"vec2f":`mat${u}x2f`,w=P=>{let O=P===0?"x":"y",E=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${b}(${E}(scale.${O}))`;case 2:return`vec2<${b}>(${E}(scale[0].${O}, scale[1].${O}))`;case 4:return`vec4<${b}>(${E}(scale[0].${O}, scale[1].${O}, scale[2].${O}, scale[3].${O}))`;default:throw new Error(`Not supported compoents ${u}`)}},v=A("input",e[0].dataType,e[0].dims,u),I=C("output",e[0].dataType,o,u);return`
  ...
  }`};r.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:y},{inputs:[e[0],m]})},o_=(r,e)=>{e.format==="NHWC"?j$(r,r.inputs,e):q$(r,r.inputs,e)}});var K$,X$,a_,s_=$(()=>{"use strict";X();ee();ne();K$=r=>{if(!r||r.length<2)throw new Error("layerNorm requires at least 2 inputs.")},X$=(r,e,n)=>{let t=e.simplified,o=r[0].dims,i=r[1],a=!t&&r[2],s=o,u=S.normalizeAxis(e.axis,o.length),l=S.sizeToDimension(o,u),c=S.sizeFromDimension(o,u),d=S.size(i.dims),p=a?S.size(a.dims):0;if(d!==c||a&&p!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${mA(e.reduction,"output[data_offset + i]","value",h.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${e.cacheKey}_${e.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:l}),getShaderSource:c}},z_=r=>Z({reduction:r.reduction}),B_=(r,e)=>{r.compute(gA(r.inputs,e),{inputs:[r.inputs[1],r.inputs[2]],outputs:[]})}});var bA,yA,_A,F_,xA,wA,TA,vA,IA,SA,$A,AA,V_,PA,OA,EA,CA,DA,G_,U_,W_=$(()=>{"use strict";X();ee();ke();ne();bA=(r,e)=>{if(r.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),r.length>0){if(e.mode==="linear"){if(!(r.length===2||r.length===3||r.length===4&&r[0]===1&&r[1]===1||r.length===4&&r[0]===1&&r[3]===1||r.length===5&&r[0]===1&&r[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
