...
const MODELS = {
    ...
    qwen2_nogqa: {
        name: "Qwen2 0.5B Instruct (no GQA)",
        desc: "Alibaba Qwen2-0.5B-Instruct (standard attention, no GQA fusion)",
        id: "Qwen/Qwen2-0.5B-Instruct",
        file_name: "model.onnx",
        external_data_file: "7906f924-70ba-11f1-8199-58cdc9c761b4.data",
        local_path: "../text-generation/models/Qwen/Qwen2-0.5B-Instruct-noGQA/",
        remote_path: "",
        eos_token_id: [151645, 151643],
        max_length: 2048,
        num_layers: 24,
