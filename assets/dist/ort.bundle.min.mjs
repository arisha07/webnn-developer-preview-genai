...
`)},type:g,offsetToIndices:I,indicesToOffset:z,broadcastedIndicesToOffset:q,indices:$,indicesGet:R,indicesSet:N,set:(...M)=>{if(M.length!==s+1)throw new Error(`indices length must be ${s}`);let G=M[s];if(typeof G!="string")throw new Error("value must be string");let be=M.slice(0,s).map(y).join(",");return s===0?X("0u",G):s===1?X(be[0],G):(b.set=!0,b.setByIndices=!0,b.indicesToOffset=!0,`set_${t}(${be}, ${G})`)},setByOffset:X,setByIndices:(M,G)=>s<2?X(M,G):(b.setByIndices=!0,b.indicesToOffset=!0,`set_${t}ByIndices(${M}, ${G});`),get:Y,getByOffset:D,getByIndices:Z,usage:n,name:t,strides:x,shape:S,rank:s}},O=(t,e,r,n=1)=>Zr(t,e,r,"input",n),U=(t,e,r,n=1)=>Zr(t,e,r,"output",n),Gs=(t,e,r)=>Zr(t,e,r,"atomicOutput",1),Qr=(t,e,r,n=1)=>Zr(t,e,r,"internal",n),mo=class{constructor(e,r){this.normalizedDispatchGroup=e;this.limits=r;this.internalVariables=[];this.variables=[];this.uniforms=[];this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(e){return`if (global_idx >= ${typeof e=="number"?`${e}u`:e}) { return; }`}mainStart(e=Dt){let r=typeof e=="number"?e:e[0],n=typeof e=="number"?1:e[1],o=typeof e=="number"?1:e[2];if(r>this.limits.maxComputeWorkgroupSizeX||n>this.limits.maxComputeWorkgroupSizeY||o>this.limits.maxComputeWorkgroupSizeZ)throw new Error(`workgroup size [${r}, ${n}, ${o}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`);if(r*n*o>this.limits.maxComputeInvocationsPerWorkgroup)throw new Error(`workgroup size [${r}, ${n}, ${o}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`);let i=this.normalizedDispatchGroup[1]===1&&this.normalizedDispatchGroup[2]===1,s=i?`@builtin(global_invocation_id) global_id : vec3<u32>,
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${e.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},vu=t=>{Sh(t.inputs),t.compute(Th(t.inputs))}});var Ih,ge,Su,Tu,Iu,Cu,Au,Eu,ku,Pu,Ou,Ch,zu,Du,Bu,Mu,nr,Ru,en,Uu,Nu,Vu,Lu,Wu,Gu,Hu,Fu,qu,Ku,ju,Zu,Qu,Yu,Xu,Ju,ed,td,_o,wo,rd,nd,od,Ah,Eh,id,tn=V(()=>{"use strict";J();re();Ce();oe();Ih=(t,e,r,n,o,i,s)=>{let u=Math.ceil(e/4),d="";typeof o=="string"?d=`${o}(a)`:d=o("a");let c=O("inputData",r,[u],4),p=U("outputData",n,[u],4),m=[{name:"vec_size",type:"u32"}];return s&&m.push(...s),`
...
`}return Q};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${e.activation};${m};${g};${y};${o}`,inputDependencies:_?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(b/64)},programUniforms:T}),getShaderSource:I}}});var Nh,Vh,$o,Id,Lh,vo,Wh,ir,sn=V(()=>{"use strict";J();re();oe();St();an();nn();Nh=(t,e)=>t?`
...
`)}
  ...
  }`};return t.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${d};${u};${g}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:b,dataType:1}],dispatchGroup:{x:m},programUniforms:S}),getShaderSource:x},{inputs:[e,r,n],outputs:[-1]})[0]},Wg=(t,e,r)=>{let n=e[0].dims,o=n,i=2,s=n[0],u=n[1],d=k.sizeFromDimension(n,i),c=fe(d),p=k.size(o)/c,m=Bl(t,e[0],e[1],e[2],s,d,u,r.epsilon),g=[s,u,d/c],y=[s,u],b=["type","none"],_=S=>{let x=O("x",e[0].dataType,g.length,c),v=O("scale_shift",1,y.length,2),T=U("output",e[0].dataType,g.length,c),I=[x,v,T];return`
