...
`}var $0,A0,Qd,ep=$(()=>{"use strict";xe();De();pe();tr();$0=r=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${r}`}),A0=(r,e,n,t)=>{let o=e.dims,i=t,a="";for(let l=0;l<4;l++){let c="";switch(l){case 0:c="outputCoords = rc;";break;case 1:c="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:c="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:c="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}a+=`
  ...
  }`;return{...lp,output:{dims:e[0].dims,type:e[0].type,textureType:0},shaderSource:s}},N0=r=>{if(!r||r.length!==5)throw new Error("BatchNormalization requires 5 inputs.");let e=r[0],n=r[1],t=r[2],o=r[3],i=r[4];if(e.dims.length<3||n.dims.length!==1||t.dims.length!==1||o.dims.length!==1||i.dims.length!==1)throw new Error("invalid input shape.");if(n.dims[0]!==e.dims[1]||t.dims[0]!==e.dims[1]||o.dims[0]!==e.dims[1]||i.dims[0]!==e.dims[1])throw new Error("invalid input shape.");if(e.type!=="float32"&&e.type!=="float64"||n.type!=="float32"&&n.type!=="float64"||t.type!=="float32"&&t.type!=="float64"||o.type!=="float32"&&o.type!=="float64"||i.type!=="float32"&&i.type!=="float64")throw new Error("invalid input tensor types.")}});var Uo,gt,B,qr,Wo,In=$(()=>{"use strict";Uo=class{constructor(e,n,t,o){this.glContext=e;this.programInfo=n;this.inputTextureLayouts=t;this.outputTextureLayout=o}},gt=class{constructor(e){this.context=e}},B=class{constructor(e,n){this.routineBody=e;this.dependencies=n}},qr=class{constructor(e,n,t){this.name=e;t?this.dependencies=t:this.dependencies=[],n&&(this.routineBody=n)}addDependency(e){e&&this.dependencies.push(e)}},Wo=class{static returnOrderedNodes(e){if(!e||e.length===0)return[];if(e.length===1)return e;let n=new Set,t=new Set,o=new Array;return this.createOrderedNodes(e,n,t,o),o}static createOrderedNodes(e,n,t,o){for(let i=0;i<e.length;++i)this.dfsTraverse(e[i],n,t,o)}static dfsTraverse(e,n,t,o){if(!e||t.has(e.name))return;if(n.has(e.name))throw new Error("Cyclic dependency detected. Can't topologically sort routines needed for shader.");n.add(e.name);let i=e.dependencies;if(i&&i.length>0)for(let a=0;a<i.length;++a)this.dfsTraverse(i[a],n,t,o);o.push(e),t.add(e.name),n.delete(e.name)}}});function z0(){let r="add_";return{body:`
...
`)},kp=r=>se({axis:r.attributes.getInt("axis")}),sI=r=>{if(!r||r.length<1)throw new Error("too few inputs");let e=r[0].type,n=r[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of r){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==n)throw new Error("input tensors should have the same shape")}}});function uI(){return yt("abs")}function lI(){return yt("acos")}function cI(){return yt("asin")}function dI(){return yt("atan")}function pI(){return yt("ceil")}function fI(){return yt("cos")}function hI(r){let e="elu";return{body:`
  ...
  `,name:r,type:0}}var $I,ze,Np,Rp,zp,Bp,uu,Mp,Fp,AI,Vp,Gp,Up,Wp,Hp,qp,lu,jp,Kp,Xp,Zp,Jp,Qp,Yp,ef,tf,nf,rf,cu=$(()=>{"use strict";We();xe();In();De();pe();$I=(r,e,n,t)=>{let o=r.session.pack?2:0,i=q(r.session.backend.glContext.version);return{...e,output:{dims:n.dims,type:n.type,textureType:o},shaderSource:`
     ${t.body}
     void main() {
...
`)},v2=r=>{if(!r||r.length!==1)throw new Error("ImageScaler requires 1 input.");if(r[0].dims.length!==4)throw new Error("Invalid input shape.");if(r[0].type!=="float32"&&r[0].type!=="float64")throw new Error("Invalid input type.")}});var Mf,Ff,Bf,I2,S2,$2,A2,P2,O2,Vf=$(()=>{"use strict";De();pe();Mf=(r,e,n)=>{O2(e);let t=r.run(S2(e[0]),e);return[r.run(P2(r,e[0],n,t.dims),[e[0],t,e[1],e[2]])]},Ff=r=>r.attributes.getFloat("epsilon",1e-5),Bf={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},I2=(r,e)=>{let n=e.dims.slice(),t=n[1],o=n[2]*n[3],i=[n[0],t],a=`
      vec4 process(int[2] indices) {
        ...
        return v;
      }`;return{...r,output:{dims:i,type:e.type,textureType:4},shaderSource:a}},S2=r=>({...Bf,get:()=>I2(Bf,r)}),$2={name:"InstanceNormalization_ComputeOutput",inputNames:["X","MeanAndVariance","Scale","B"],inputTypes:[0,4,0,0]},A2=(r,e,n,t,o)=>{let i=q(r.session.backend.glContext.version),[a,s]=r.calculateTextureWidthAndHeight(o,4),[u,l]=[a/4,s],c=`
...
`)}
    ...
    `;return{...n,output:{dims:o,type:e[0].type,textureType:0},shaderSource:s}},pS=r=>{if(!r||r.length!==2)throw new Error("Tile requires 2 input.");if(r[1].dims.length!==1)throw new Error("The second input shape must 1 dimension.");if(r[1].dims[0]!==r[0].dims.length)throw new Error("Invalid input shape.");if(zn.indexOf(r[0].type)===-1)throw new Error("Invalid input type.");if(r[1].type!=="int32"&&r[1].type!=="int16")throw new Error("Invalid repeat type.")}});var Au,Yh,em,fS,hS,tm=$(()=>{"use strict";xe();Au=(r,e,n)=>{fS(e);let t=G.unsqueezeShape(e[0].dims,n);return[r.reshapeUnpacked(e[0],t)]},Yh=(r,e)=>(hS(e),Au(r,[e[0]],Array.from(e[1].integerData))),em=r=>r.attributes.getInts("axes"),fS=r=>{if(!r||r.length!==1)throw new Error("Unsqueeze requires 1 input.");if(r[0].type==="string")throw new Error("invalid input tensor types.")},hS=r=>{if(!r||r.length!==2)throw new Error("Unsqueeze requires 2 inputs.");if(r[1].type!=="int32")throw new Error("Invalid input type.")}});var nm,rm=$(()=>{"use strict";pp();Sp();Pp();Lp();qo();yf();If();Af();Ef();Lf();zf();Vf();Hf();jo();Xf();uh();gh();yh();Ih();$h();Ch();Vh();Hh();Kh();Zh();Qh();Xo();cu();tm();Tu();nm=[["Abs","","6+",Np],["Acos","","7+",Rp],["Add","","7+",fp],["And","","7+",hp],["Asin","","7+",zp],["Atan","","7+",Bp],["AveragePool","","7+",Jf,Qf],["BatchNormalization","","7+",cp,dp],["Cast","","6+",$p,Ap],["Ceil","","6+",Vp],["Clip","","6-10",uu,Mp],["Clip","","11+",Fp],["Concat","","4+",Cp,kp],["Conv","","1+",gu,bu],["ConvTranspose","","1+",gf,bf],["Cos","","7+",Gp],["Div","","7+",mp],["Dropout","","7+",lu],["DepthToSpace","","1+",Tf,vf],["Equal","","7+",gp],["Elu","","6+",Up,Wp],["Exp","","6+",Hp],["Flatten","","1+",Sf,$f],["Floor","","6+",qp],["FusedConv","com.microsoft","1+",gu,bu],["Gather","","1+",Pf,Of],["Gemm","","7-10",yu,Df],["Gemm","","11+",yu,kf],["GlobalAveragePool","","1+",eh,th],["GlobalMaxPool","","1+",ah],["Greater","","7+",bp],["Identity","","1+",lu],["ImageScaler","","1+",Nf,Rf],["InstanceNormalization","","6+",Mf,Ff],["LeakyRelu","","6+",jp,Kp],["Less","","7+",yp],["LRN","","1+",Gf,Uf],["Log","","6+",Xp],["MatMul","","1+",lf,cf],["MaxPool","","1+",nh,rh],["Mul","","7+",_p],["Neg","","6+",Zp],["Not","","1+",Jp],["Or","","7+",xp],["Pad","","2-10",_u,qf],["Pad","","11+",jf,Kf],["Pow","","7+",wp],["PRelu","","7+",Tp],["ReduceLogSum","","1+",hh,Bn],["ReduceMax","","1+",dh,Bn],["ReduceMean","","1+",ch,Bn],["ReduceMin","","1+",ph,Bn],["ReduceProd","","1+",fh,Bn],["ReduceSum","","1-12",lh,Bn],["ReduceSumSquare","","1+",mh,Bn],["Relu","","6+",Qp],["Reshape","","5+",bh],["Resize","","10",Iu,Th],["Resize","","11+",Iu,vh],["Shape","","1+",Sh],["Sigmoid","","6+",Yp],["Sin","","7+",ef],["Slice","","10+",Eh],["Slice","","1-9",Ah,Ph],["Softmax","","1-12",Nh,Rh],["Softmax","","13+",Bh,zh],["Split","","2-12",Uh,Wh],["Sqrt","","6+",tf],["Squeeze","","1-12",$u,jh],["Squeeze","","13+",qh],["Sub","","7+",vp],["Sum","","6+",Xh],["Tan","","7+",nf],["Tanh","","6+",rf],["Tile","","6+",Jh],["Transpose","","1+",rr,xf],["Upsample","","7-8",xu,xh],["Upsample","","9",xu,wh],["Unsqueeze","","1-12",Au,em],["Unsqueeze","","13+",Yh],["Xor","","7+",Ip]]});function im(r){let e={},n;for(;(n=om.exec(r))!==null;){let t=n[3].split(",").map(o=>{let i=o.trim().split(" ");return i&&i.length===2?{type:i[0],name:i[1]}:null}).filter(o=>o!==null);e[n[2]]={params:t,body:n[4]}}for(let t in e){let o=mS.replace("__FUNC__",t),i=new RegExp(o,"gm");for(;(n=i.exec(r))!==null;){let a=n[1],s=n[2],u=n[3].split(","),l=a?`${a} ${s};`:"",c=e[t].body,d="";e[t].params.forEach((f,h)=>{f&&(d+=`${f.type} ${f.name} = ${u[h]};
`)}),c=`${d}
 ${c}`,c=c.replace("return",`${s} = `);let p=`
    ...
    `)}getOutputPacked1DCoords(e,n){let t=n,o="";return t[0]===1?(o=`
      ...
      `,new B(o))}getOutputPacked2DCoords(e,n){let t="";if(Zn.arraysEqual(e,n))return t=`
...
`);let y="";c<2&&l>0?y="coords":y=i.map((O,E)=>`coords.${m[E+f]}`).join(", ");let g="return outputValue;",x=G.size(i)===1,v=G.size(a)===1;if(l===1&&!x&&!v)g=`
    ...
    `;return new B(P,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(e,n,t,o){let i=[t.width,t.height],a=[n.width,n.height],s=n.unpackedShape.length,u=t.unpackedShape.length,l=n.unpackedShape,c=t.unpackedShape,d=Mo(o);if(s===u&&Zn.arraysEqual(a,i)){let x=`
          float ${e}() {
            return sampleTexture(${o}, TexCoords);
          }
        `;return new B(x,["coordinates.sampleTexture"])}let p=Qe(u),f=Je.getBroadcastDims(l,c),h=u-s,m,y=$t();s===0?m="":u<2&&f.length>=1?m="coords = 0;":m=f.map(x=>`coords.${y[x+h]} = 0;`).join(`
`);let g="";u<2&&s>0?g="coords":g=n.unpackedShape.map((x,w)=>`coords.${y[w+h]}`).join(", ");let b=`
      ...
      `;return new B(b,["coordinates.getOutputCoords"])}getPackedSamplerFromInput(e,n,t){switch(t.unpackedShape.length){case 0:return this.getPackedSamplerScalar(e,n);case 1:return this.getPackedSampler1D(e,n,t);case 2:return this.getPackedSampler2D(e,n,t);case 3:return this.getPackedSampler3D(e,n,t);default:return this.getPackedSamplerND(e,n,t)}}getUnpackedSamplerFromInput(e,n,t){let o=t.unpackedShape;switch(o.length){case 0:return this.getUnpackedSamplerScalar(e,n,t);case 1:return this.getUnpackedSampler1D(e,n,t);case 2:return this.getUnpackedSampler2D(e,n,t);case 3:return this.getUnpackedSampler3D(e,n,t);case 4:return this.getUnpackedSampler4D(e,n,t);case 5:return this.getUnpackedSampler5D(e,n,t);case 6:return this.getUnpackedSampler6D(e,n,t);default:throw new Error(`Unsupported dimension ${o.length}-D`)}}getPackedSamplerScalar(e,n){let t=q(this.context.glContext.version),o=`
        ...
        `;return new B(o)}getPackedSampler1D(e,n,t){let o=[t.width,t.height],i=[o[1],o[0]],a=q(this.context.glContext.version),u=`vec4 ${e}(int index) {
      vec2 uv = packedUVfrom1D(
      ${i[0]}, ${i[1]}, index);
      return ${a.texture2D}(${n}, uv);
    }`;return new B(u,["coordinates.packedUVfrom1D"])}getPackedSampler2D(e,n,t){let o=t.unpackedShape,i=[t.width,t.height],a=q(this.context.glContext.version),s=i[0],u=i[1];if(i!=null&&Zn.arraysEqual(o,i)){let f=`vec4 ${e}(int row, int col) {
      ...
      vec4 ${e}(int b, int row, int col) {
        return ${e}(${yr(g,m)});
      } `;return new B(v,x.dependencies)}let u=a[0],l=a[1],c=Math.ceil(o[2]/2),d=c*Math.ceil(o[1]/2),f=`vec4 ${e}(int b, int row, int col) {
      ...
      `;return new B(a,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler2D(e,n,t){let o=t.unpackedShape,i=[t.height,t.width];if(i!=null&&Zn.arraysEqual(o,i)){let p=i[1],f=i[0],h=`
          float ${e}(int row, int col) {
            vec2 uv = (vec2(row, col) + halfCR) / vec2(${p}.0, ${f}.0);
            return sampleTexture(${n}, uv);
          }
        `;return new B(h,["coordinates.sampleTexture"])}let{newShape:a,keptDims:s}=Tr(o),u=a;if(u.length<o.length){let p=br(o,u),f=JSON.parse(JSON.stringify(t));f.unpackedShape=p;let h=["col","row"],m=`
      ...
      `;return new B(c,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler5D(e,n,t){let o=t.unpackedShape,i=o[4],a=o[3]*i,s=o[2]*a,u=o[1]*s,{newShape:l,keptDims:c}=Tr(o);if(l.length<o.length){let h=br(o,l),m=["row","col","depth","depth2","depth3"],y=JSON.parse(JSON.stringify(t));y.unpackedShape=h;let g=`
    ...
    `;return{toVec:new B(s,["coordinates.coordsToOffset"])}}valueFrom(){let e={};return this.context.programInfo.inputNames.forEach((n,t)=>{let o=this.context.inputTextureLayouts[t],a=(o.unpackedShape.length>0?o.unpackedShape:o.shape).length,s=`_${n}`;e[s]=new B(this.getValueFromSingle(n,a,o.width,o.height,!1),[`shapeUtils.indicesToOffset${s}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"]),s=s+"_T",e[s]=new B(this.getValueFromSingle(n,a,o.width,o.height,!0),[`shapeUtils.indicesToOffset${s}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"])}),e}getValueFromSingle(e,n,t,o,i){let a=`_${e}`;i&&(a=a+"_T");let s=q(this.context.glContext.version);return`
        ...
        `}}});var ti,lm=$(()=>{"use strict";In();ti=class r extends gt{constructor(e){super(e)}getFunctions(){return{...this.encodeFloat32(),...this.decodeFloat32()}}getCustomTypes(){return{}}encodeFloat32(){return{encode:new B(`highp vec4 encode(highp float f) {
...
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = min(value, ${t.getByIndices("input_indices")});`,""]})},y1=(r,e)=>{_n(r.inputs),xn(r,"ReduceProd",e,(t,o)=>[`var value = ${o.type.storage}(1);`,"",`value *= ${t.getByIndices("input_indices")};`,""])},_1=(r,e)=>{_n(r.inputs),xn(r,"ReduceSum",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,""])},x1=(r,e)=>{_n(r.inputs),xn(r,"ReduceSumSquare",e,(t,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += t * t;`,""])},wn=(r,e,n)=>{if(e.length===0)return n;let t=1,o=1;for(let i=0;i<e.length;i++)e.indexOf(i)===-1?t*=r[i]:o*=r[i];return o<32&&t>1024},Ag=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?g1(r,e):gg(r,e)},Pg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?p1(r,e):bg(r,e)},Og=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?f1(r,e):yg(r,e)},Eg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?h1(r,e):_g(r,e)},Cg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?m1(r,e):xg(r,e)},Dg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?b1(r,e):wg(r,e)},kg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?y1(r,e):Tg(r,e)},Lg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?_1(r,e):vg(r,e)},Ng=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?x1(r,e):Ig(r,e)},Rg=(r,e)=>{wn(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?d1(r,e):Sg(r,e)}});var zg,Bg,Mg,nl,Fg=$(()=>{"use strict";X();ke();Vi();zg=r=>{if(!r||r.length===0||r.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(r[0].dataType!==1)throw new Error("Invalid input type.")},Bg=(r,e)=>{zg(r.inputs);let n=(t,o,i)=>{let a=[];for(let s=0;s<t.rank;s++)(i.indexOf(s)>=0||i.length===0)&&a.push(`input_indices[${s}] = 0;`);return[`${a.join(`
...
var best_index : i32 = 0;`,`if (${t.getByIndices("input_indices")} ${e.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${e.epsilon}_${e.format}_${t}_${a}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:b,getRunData:()=>({outputs:[{dims:r[0].dims,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...k(i)]:[{type:12,data:u}]})}},P1=r=>Z(r),Gg=(r,e)=>{let{inputs:n,outputCount:t}=r,o=P1({...e,outputCount:t});if(Y.webgpu.validateInputContent&&$1(n,o),e.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");r.compute(A1(n,o))}});var O1,E1,Wg,Hg=$(()=>{"use strict";ee();ne();O1=r=>{if(r[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(r[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(r[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(r[0].dims[2]!==r[1].dims[0])throw new Error("last dimension of input and bias are not the same")},E1=r=>{let e=r[0].dims,n=r[0].dims[2],t=S.size(e)/4,o=r[0].dataType,i=A("input",o,e,4),a=A("bias",o,[n],4),s=A("residual",o,e,4),u=C("output",o,e,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:e,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(t/64)}}),getShaderSource:c=>`
  ...
  }`}},Wg=r=>{O1(r.inputs),r.compute(E1(r.inputs))}});var C1,be,qg,jg,Kg,Xg,Zg,Jg,Qg,Yg,eb,D1,tb,nb,rb,ob,to,ib,Wi,ab,sb,ub,lb,cb,db,pb,fb,hb,mb,gb,bb,yb,_b,xb,wb,Tb,vb,ol,il,Ib,Sb,$b,k1,L1,Ab,Hi=$(()=>{"use strict";X();ee();ke();ne();C1=(r,e,n,t,o,i,a)=>{let s=Math.ceil(e/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let l=A("inputData",n,[s],4),c=C("outputData",t,[s],4),d=[{name:"vec_size",type:"u32"}];return a&&d.push(...a),`
...
`,il=r=>`(fast_gelu_a + fast_gelu_a * tanh_v(${r} * (fast_gelu_c * ${r} * ${r} + fast_gelu_b))) * ${r}`,Ib=r=>{let e=Ve(r.inputs[0].dataType);r.compute(be(r.inputs[0],"FastGelu",il,ol(e),void 0,r.inputs[0].dataType))},Sb=(r,e)=>{let n=Ve(r.inputs[0].dataType);return r.compute(be(r.inputs[0],"ThresholdedRelu",t=>`select(vec4<${n}>(0.0), ${t}, ${t} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${e.alpha});`,e.cacheKey)),0},$b=r=>{r.compute(be(r.inputs[0],"Log","log"))},k1=(r,e)=>`
...
`,L1=r=>`quick_gelu_impl(${r})`,Ab=(r,e)=>{let n=Ve(r.inputs[0].dataType);r.compute(be(r.inputs[0],"QuickGelu",L1,k1(n,e.alpha),e.cacheKey,r.inputs[0].dataType))}});var N1,R1,Ob,Eb=$(()=>{"use strict";ee();ne();Hi();N1=r=>{if(r[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(r[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(r[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(r[0].dims[2]!==r[1].dims[0])throw new Error("last dimension of input and bias are not the same")},R1=r=>{let e=r[0].dims.slice();e[2]=e[2]/2;let n=A("input",r[0].dataType,r[0].dims,4),t=A("bias",r[0].dataType,[r[0].dims[2]],4),o=C("output",r[0].dataType,e,4),i=S.size(e)/4,a=ve(r[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:e,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
...
`}return W};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${e.activation};${d};${p};${f};${o}`,inputDependencies:m?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:x}),getShaderSource:w}}});var W1,H1,al,Kb,q1,sl,j1,ro,Zi=$(()=>{"use strict";X();ee();ne();Gn();Xi();ji();W1=(r,e)=>r?`
...
`},j1=(r,e,n,t,o=!1)=>{let[i,a,s,u]=t,l=ve(t[0].type.tensor);return`
  ...
  ${m?al(y,g,W,V):sl(y,g,W,V)}
    ...
    return ${Me(s,l)}(0.0);`,v=Me(u,l),I=r?Me(a,l):Me(s,l),P=r?Me(s,l):Me(a,l),O=Pt(i,v,l);return`
  ...
  ${h.mainStart()}
    ...
    ${xt}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${e.cacheKey};${c}${m}${h}${d}${f}`,inputDependencies:b},getRunData:()=>({dispatchGroup:{x:g[0],y:g[1],z:g[2]},outputs:[{dims:n?n(o):o,dataType:r[0].dataType}],programUniforms:O}),getShaderSource:E}}});var n$,r$,o$,ly,cy,i$,dy,a$,py,fy=$(()=>{"use strict";uy();Gn();Sn();n$=(r,e,n,t,o,i)=>(r-1)*e+n+(t-1)*o+1-i,r$=(r,e,n,t,o)=>{let i=Math.floor(r/2);e==="SAME_UPPER"?(n[t]=i,n[o]=r-i):e==="SAME_LOWER"&&(n[t]=r-i,n[o]=i)},o$=(r,e,n,t,o,i,a,s,u,l)=>{let c=r.length-2,d=l.length===0;u.length<c&&u.push(...Array(c-u.length).fill(0));let p=r[0],f=e[s?3:1]*o;for(let h=0,m=r.length-c-(s?1:0);h<c;++h,++m){let y=r[m],g=d?y*a[h]:l[h],b=n$(y,a[h],i[h],e[m],n[h],g);r$(b,t,i,h,h+c),d&&l.push(a[h]*(y-1)+u[h]+(e[m]-1)*n[h]+1-i[h]-i[h+c])}l.splice(0,0,p),l.splice(s?3:1,0,f)},ly=(r,e)=>{let n=r.kernelShape.slice();if(r.kernelShape.length===0||r.kernelShape.reduce((d,p)=>d*p,1)===0){n.length=0;for(let d=2;d<e[1].dims.length;++d)n.push(e[1].dims[d])}let t=r.format==="NHWC";n.splice(0,0,e[1].dims[0]),n.splice(t?3:1,0,e[1].dims[1]);let o=r.pads.slice(),i=r.outputShape.slice(),a=r.outputPadding.slice(),s=e[0].dims,u=r.dilations.slice();if(u.reduce((d,p)=>d+p,0)===0){let d=e[0].dims.length-2;u=new Array(d).fill(1)}let l=r.strides.slice();if(l.reduce((d,p)=>d+p,0)===0){let d=e[0].dims.length-2;l=new Array(d).fill(1)}o$(s,n,u,r.autoPad,r.group,o,l,t,a,i);let c=Object.assign({},r);return Object.assign(c,{kernelShape:n,pads:o,outputPadding:a,outputShape:i,dilations:u,strides:l}),c},cy=r=>{let e=qi(r),n=r.format,t=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof r.autoPad>"u"?0:r.autoPad],o=r.dilations,i=r.group??1,a=r.kernelShape,s=r.pads,u=r.strides,l=r.wIsConst(),c=r.outputPadding,d=r.outputShape;return{autoPad:t,format:n,dilations:o,group:i,kernelShape:a,outputPadding:c,outputShape:d,pads:s,strides:u,wIsConst:l,...e,cacheKey:`${r.format};${e.activation};`}},i$=(r,e)=>{if(!r||r.length!==2&&r.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(r[0].dims.length!==4&&r[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(r[0].dims.length!==r[1].dims.length)throw new Error("filter does not have same dimension as input");let n=r[0].dims[e.format==="NHWC"?r[0].dims.length-1:1],t=r[1].dims[0];if(n!==t)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=r[1].dims[1]*e.group;if(r.length===3&&(r[2].dims.length!==1||r[2].dims[0]!==o))throw new Error("invalid bias");let i=r[0].dims.length-2;if(e.dilations.reduce((c,d)=>c+d,0)>0&&e.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(e.strides.reduce((c,d)=>c+d,0)>0&&e.strides.length!==i)throw new Error(`strides should be ${i}D`);if(e.pads.reduce((c,d)=>c+d,0)>0&&e.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(e.outputPadding.length!==i&&e.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(e.kernelShape.reduce((c,d)=>c+d,0)>0&&e.kernelShape.length!==0&&e.kernelShape.length!==r[1].dims.length-2)throw new Error("invalid kernel shape");if(e.outputShape.length!==0&&e.outputShape.length!==r[0].dims.length-2)throw new Error("invalid output shape")},dy=(r,e,n,t)=>{let o=r.kernelCustomData.wT??r.compute(Ge(e[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!r.kernelCustomData.wT&&(r.kernelCustomData.wT=o);let i=[e[0],o];e.length===3&&i.push(e[2]),r.compute(sy(i,n,t),{inputs:i})},a$=(r,e)=>{let n=e.format==="NHWC",t=[r.inputs[0].reshape(n?[r.inputs[0].dims[0],1,r.inputs[0].dims[1],r.inputs[0].dims[2]]:[r.inputs[0].dims[0],r.inputs[0].dims[1],1,r.inputs[0].dims[2]]),r.inputs[1].reshape([r.inputs[1].dims[0],r.inputs[1].dims[1],1,r.inputs[1].dims[2]])];r.inputs.length===3&&t.push(r.inputs[2]);let o=e.kernelShape;(o.length===0||o[0]===0)&&(o=[r.inputs[1].dims[2]]);let i=e.dilations;(i.length===0||i[0]===0)&&(i=[1]);let a=e.strides;(a.length===0||a[0]===0)&&(a=[1]);let s=e.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],a=[1].concat(a),i=[1].concat(i),o=[1].concat(o);let u=e.outputPadding;u=[0].concat(u);let l=ly({...e,pads:s,strides:a,dilations:i,kernelShape:o,outputPadding:u},t);dy(r,t,l,c=>n?[c[0],c[2],c[3]]:[c[0],c[1],c[3]])},py=(r,e)=>{if(i$(r.inputs,e),r.inputs[0].dims.length===3)a$(r,e);else{let n=ly(e,r.inputs);dy(r,r.inputs,n)}}});var s$,hy,my,gy=$(()=>{"use strict";X();ee();ke();ne();s$=(r,e,n,t)=>{let o=S.size(e),i=e.length,a=A("input",r,i),s=C("output",r,i),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=S.normalizeAxis(u,i),c=d=>{let p=` i32(${a.indicesGet("inputIndices","uniforms.axis")}) `,f=M("uniforms.input_shape","uniforms.axis",i),h=t.reverse?p+(t.exclusive?" + 1":""):"0",m=t.reverse?f:p+(t.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:e,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:l},...k(e,e)]}),getShaderSource:c}},hy=(r,e)=>{let n=r.inputs[0].dims,t=r.inputs[0].dataType,o=r.inputs[1];r.compute(s$(t,n,o,e),{inputs:[0]})},my=r=>{let e=r.exclusive===1,n=r.reverse===1;return Z({exclusive:e,reverse:n})}});var u$,l$,c$,by,yy,_y=$(()=>{"use strict";X();ee();ke();ne();u$=r=>{if(!r||r.length!==1)throw new Error("DepthToSpace requires 1 input.");if(r[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},l$=(r,e,n,t)=>{let o=[];o.push(`fn perm(i: ${t.type.indices}) -> ${n.type.indices} {
...
`)};
    ...
    ${h}`},c=[{type:12,data:u},...k(e,t)];return{name:"Expand",shaderCache:{hint:`${t.length};${a}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:t,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},$y=r=>{h$(r.inputs),r.compute(g$(r.inputs),{inputs:[0]})}});var b$,Py,Oy=$(()=>{"use strict";X();ee();ne();Hi();b$=r=>{let e=r[0].dataType,n=S.size(r[0].dims),t=S.size(r[1].dims),o=t%4===0,i=a=>{let s=A("x",e,[1],4),u=A("bias",e,[1],4),l=C("y",e,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],d=f=>`
  ...
  }`};return r.compute({name:"computeSliceOffsets",shaderCache:{hint:`${o.length}_${n.length}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:c,dataType:r.inputs[1].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:l}),getShaderSource:d},{inputs:[e],outputs:[-1]})[0]},ky=(r,e)=>{let n=r.inputs,t=n[0].dims,o=n[0].dataType,i=n[1].dims,a=i[i.length-1],s=S.sizeToDimension(i,i.length-1),u=S.sizeFromDimension(t,e.batchDims+a),l=S.sizeToDimension(t,e.batchDims),c=S.sizeFromDimension(t,e.batchDims),d=s/l,p=new Array(a),f=u;for(let w=0;w<a;++w)p[a-1-w]=f,f*=t[e.batchDims+a-1-w];let h=x$(r,n[1],p,e.batchDims,t,s,d,c,a),m=e.batchDims+a;if(m>t.length)throw new Error("last dimension of indices must not be larger than rank of input tensor");let y=i.slice(0,-1).concat(t.slice(m)),g=S.size(y),b=[{type:12,data:g},{type:12,data:u},...k(n[0].dims,h.dims,y)],x=w=>{let v=A("data",n[0].dataType,n[0].dims.length),I=A("slice_offsets",12,h.dims.length),P=C("output",n[0].dataType,y.length);return`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${r};${e}`,inputDependencies:i},getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u}),getShaderSource:l}},t_=(r,e)=>{let n=W$(r.inputs,e);if(r.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(r.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let t=r.inputs[0],o=r.inputs[1]&&r.inputs[1].dims.length>0?r.inputs[1]:void 0,i=r.inputs[2]&&r.inputs[2].dims.length>0?r.inputs[2]:void 0,a=r.inputs[3]&&r.inputs[3].dims.length!==0?r.inputs[3]:void 0,s=r.inputs[4]&&r.inputs[4].dims.length!==0?r.inputs[4]:void 0,u=r.inputs.length>4?r.inputs[5]:void 0,l=r.inputs.length>5?r.inputs[6]:void 0,c=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=Z({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,c*n.headSize,c*n.headSize]}),[p,f,h]=!o&&!i?r.compute(gl([t],d),{inputs:[t],outputs:[-1,-1,-1]}):[t,o,i],m,y;if(e.doRotary){let w=r.compute(q$(n.batchSize,n.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],v=r.inputs[7],I=r.inputs[8],P=Z({interleaved:e.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:e.scale}),O=[p,w,v,I],E=[-1];m=r.compute(Yi(O,P),{inputs:O,outputs:E})[0],O.splice(0,1,f);let R=Z({interleaved:e.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:e.scale});y=r.compute(Yi(O,R),{inputs:O,outputs:E})[0]}let g=oo(r,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,e.doRotary?m:p,void 0,0),b=e_(r,e.doRotary?y:f,n),x=e_(r,h,n);Sr(r,g,b,x,void 0,void 0,a,s,void 0,n,u,l)}});var r_,j$,K$,o_,i_=$(()=>{"use strict";X();ee();Sn();ne();r_=(r,e,n,t,o,i,a,s)=>{let u=he(i),l=u===1?"f32":`vec${u}f`,c=u===1?"vec2f":`mat2x${u}f`,d=o*a,p=64;d===1&&(p=256);let f=[o,a,i/u],h=[o,a,2],m=["rank","type","type"],y=[];y.push(...k(f,h));let g=b=>{let x=A("x",e.dataType,3,u),w=A("scale",n.dataType,n.dims),v=A("bias",t.dataType,t.dims),I=C("output",1,3,2),P=[x,w,v,I];return`
  ...
  }`};return r.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${s};${p}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:h,dataType:1}],dispatchGroup:{x:d},programUniforms:y}),getShaderSource:g},{inputs:[e,n,t],outputs:[-1]})[0]},j$=(r,e,n)=>{let t=e[0].dims,o=t,i=2,a=t[0],s=t[1],u=S.sizeFromDimension(t,i),l=he(u),c=S.size(o)/l,d=r_(r,e[0],e[1],e[2],a,u,s,n.epsilon),p=[a,s,u/l],f=[a,s],h=["type","none"],m=y=>{let g=A("x",e[0].dataType,p.length,l),b=A("scale_shift",1,f.length,2),x=C("output",e[0].dataType,p.length,l),w=[g,b,x];return`
  ...
  }`};r.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...k(p,f,p)]}),getShaderSource:m},{inputs:[e[0],d]})},K$=(r,e,n)=>{let t=e[0].dims,o=t,i=t[0],a=t[t.length-1],s=S.sizeFromDimension(t,1)/a,u=he(a),l=S.size(o)/u,c=[{type:12,data:s},{type:12,data:Math.floor(a/u)}],d=["type","type"],p=!1,f=[0,t.length-1];for(let g=0;g<t.length-2;g++)p=p||t[g+1]!==1,f.push(g+1);p=p&&t[t.length-1]!==1;let h=p?r.compute(Ge(r.inputs[0],f),{inputs:[r.inputs[0]],outputs:[-1]})[0]:r.inputs[0].reshape(Array.from({length:t.length},(g,b)=>t[f[b]])),m=r_(r,h,e[1],e[2],i,s,a,n.epsilon),y=g=>{let b=ve(e[0].dataType),x=u===1?"vec2f":`mat${u}x2f`,w=P=>{let O=P===0?"x":"y",E=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${b}(${E}(scale.${O}))`;case 2:return`vec2<${b}>(${E}(scale[0].${O}, scale[1].${O}))`;case 4:return`vec4<${b}>(${E}(scale[0].${O}, scale[1].${O}, scale[2].${O}, scale[3].${O}))`;default:throw new Error(`Not supported compoents ${u}`)}},v=A("input",e[0].dataType,e[0].dims,u),I=C("output",e[0].dataType,o,u);return`
  ...
  }`};r.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:y},{inputs:[e[0],m]})},o_=(r,e)=>{e.format==="NHWC"?K$(r,r.inputs,e):j$(r,r.inputs,e)}});var X$,Z$,a_,s_=$(()=>{"use strict";X();ee();ne();X$=r=>{if(!r||r.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Z$=(r,e,n)=>{let t=e.simplified,o=r[0].dims,i=r[1],a=!t&&r[2],s=o,u=S.normalizeAxis(e.axis,o.length),l=S.sizeToDimension(o,u),c=S.sizeFromDimension(o,u),d=S.size(i.dims),p=a?S.size(a.dims):0;if(d!==c||a&&p!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${gA(e.reduction,"output[data_offset + i]","value",h.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${e.cacheKey}_${e.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:l}),getShaderSource:c}},z_=r=>Z({reduction:r.reduction}),B_=(r,e)=>{r.compute(bA(r.inputs,e),{inputs:[r.inputs[1],r.inputs[2]],outputs:[]})}});var yA,_A,xA,F_,wA,TA,vA,IA,SA,$A,AA,PA,V_,OA,EA,CA,DA,kA,G_,U_,W_=$(()=>{"use strict";X();ee();ke();ne();yA=(r,e)=>{if(r.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),r.length>0){if(e.mode==="linear"){if(!(r.length===2||r.length===3||r.length===4&&r[0]===1&&r[1]===1||r.length===4&&r[0]===1&&r[3]===1||r.length===5&&r[0]===1&&r[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
